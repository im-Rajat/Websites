...
- https://flixtor.gg/    (Flixtor : Hollywood Movies/WebSeries)
...
- http://netflix.com/watch-free    (Netflix Free Shows)
...
- https://www.useblackbox.io/    (Extract Code from Any Video and Turn any Question into Code)
- https://cursa.app/en    (Do any course with certification)
- https://cheatography.com/    (Free Cheat Sheets, Revision Aids and Quick References)
- https://you.com/search?q=code+translator&fromSearchBar=true    (Code Translator - Convert code from 1 language to another)
- https://texttohandwriting.com/ (Convert text to handwriting)
- https://videoglancer.com/   (Youtube to PDF)
...
- https://lecoupa.github.io/awesome-cheatsheets/    (Cheat Sheets for popular programming languages, frameworks and development tools)
- https://gitsheet.wtf/    (Git cheat sheet)
...
- https://www.hiddentools.dev/    (Collection of unique tools)
